...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', 'twentyten' ) )  ) : ?>
		...
		<?php if ( is_front_page() || is_archive() || is_search() ) : // Display excerpts for archives and search. ?>
                            <?php if (has_excerpt ()): ?>
                        ...
                        <div class="featured_image">
                            <?php
                                if (has_post_thumbnail())
                                {
                                    ...
                                    echo get_the_post_thumbnail(get_the_ID(), 'full', $img_attrs);
                                }
                                else
                                {
                                    echo '<img src="' . get_bloginfo ('stylesheet_directory') . '/images/default_featured.jpg" width="460" alt="image" />';
                                }
                            ?>
                        </div>
